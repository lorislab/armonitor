...
public class BuildMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
            ...
            File dir = new File(output, ArmConstant.DIR_LOCATION);
            if (!dir.exists()) {
                dir.mkdirs();
            }
            File file = new File(dir, ArmConstant.FILE_NAME);

            Properties properties = new Properties();
            properties.put(ArmConstant.MAVEN_GROUP_ID, project.getGroupId());
            properties.put(ArmConstant.MAVEN_ARTIFACT_ID, project.getArtifactId());
            properties.put(ArmConstant.MAVEN_VERSION, project.getVersion());
            ...
            properties.put(ArmConstant.RELEASE_SCM, releaseScm);
