...
/**
 * The deploy system builds log parameter.
 *
 * @author Andrej Petras
 */
@MetaInfServices
public class DeploySystemBuildsLogParameter implements ClassLogParameter {
    ...
    public List<Class<?>> getClasses() {
        ...
        result.add(DeploySystemBuilds.class);
        return result;
    }
    ...
    public Object getObject(Object parameter) {
        DeploySystemBuilds tmp = (DeploySystemBuilds) parameter;
