 ...
 */
public class StoreSCMSystemCriteria extends AbstractSearchCriteria {
    
    private static final long serialVersionUID = 5335960103921856211L;
    ...
    public boolean isEmpty() {
        return isEmpty(guid, application);
    }
