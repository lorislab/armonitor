controllers.controller('SystemAdminCtrl', function($scope, $routeParams, SystemAdminService) {
	...
	$scope.delete = function() {
		SystemAdminService.delete({guid: $routeParams.guid}, function(response) {
			history.back();
		});
	};
});
...
controllers.controller('SystemAgentAdminCtrl', function($scope, $routeParams, SystemAdminService, AgentAdminService) {
